...
<div id="app-add" style="padding-bottom: 50px">
    <div class="row align-items-start">
        ...
        <div v-if="dealFields.selectedOptionTypeCompany === 'fl' || dealFields.selectedOptionTypeCompany === 'ip' || dealFields.selectedOptionTypeCompany === 'ul' || dealFields.selectedOptionTypeCompany === 'other'">
            <div class="row align-items-start">
                <div class="col">
                    ...
                    <label for="connectionAddress" class="form-label">Адрес подключения</label>
                    <input
                    ...
                    <div
                        v-if="dealFields.selectedOptionTypeCompany === 'ip' || dealFields.selectedOptionTypeCompany === 'ul' || dealFields.selectedOptionTypeCompany === 'other'">
                ...
                <div class="col">
                    ...
                    <label for="contactNameTech" class="form-label">Контактное лицо (по тех вопросам)</label>
                    <input
                        id="contactNameTech"
                        type="text"
                        class="form-control needs-validation"
                    ...
                    <label for="contactPhoneTech" class="form-label">Сотовый номер (по тех вопросам)</label>
                    <input
                        id="contactPhoneTech"
                        type="text"
                    ...
                    <label for="contactNameAgreement" class="form-label">Контактное лицо (по Договору)</label>
                    <input
                    ...
                    <label for="contactPhoneAgreement" class="form-label">Сотовый номер (по Договору)</label>
                    <input
                    ...
                    <label for="contactNamePayment" class="form-label">Контактное лицо (по оплате)</label>
                    <input
                    ...
                    <label for="contactPhonePayment" class="form-label">Сотовый номер (по оплате)</label>
                    <input
                    ...
                    <label for="agreementDate" class="form-label">Дата составления договора</label>
                    <input
                        id="agreementDate"
                        type="text"
                        class="form-control needs-validation"
                ...
                <div class="col">
                    ...
                    <label for="signatorePhone" class="form-label">Подписант сотовый номер</label>
                    <input
                        id="signatorePhone"
                        type="text"
                        class="form-control needs-validation"
                    ...
                    <div v-if="dealFields.selectedOptionTypeCompany === 'ip' || dealFields.selectedOptionTypeCompany === 'ul' || dealFields.selectedOptionTypeCompany === 'other'">

                        <label for="positionSignatory" class="form-label">Должность подписанта</label>
                        <input
                        ...
                        <label for="reasonForSigning" class="form-label">Основание для подписания</label>
                        <input
                            id="reasonForSigning"
                            type="text"
                            class="form-control needs-validation"
                    ...
                    <div class="row">
                        <div
                            v-if="dealFields.selectedOptionTypeCompany === 'ip' || dealFields.selectedOptionTypeCompany === 'fl'">
                        ...
                        <div
                            v-if="dealFields.selectedOptionTypeCompany === 'ul' || dealFields.selectedOptionTypeCompany === 'other'">
                            <div class="col">
                                <label for="registrationCertificate" class="form-label">Свидетельство о
                                    регистрации</label>
                                <input
                                    type="file"
                                    class="form-control needs-validation"
                            ...
                            <div class="col">
                                <label for="orderForDirector" class="form-label">Приказ на
                                    Директора/Доверенность</label>
                                <input
                                    type="file"
                                    class="form-control needs-validation"
                                    id="orderForDirector"
